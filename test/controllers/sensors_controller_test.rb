...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference("Sensor.count") do
      post sensors_url, params: { sensor: { description: @sensor.description, name: @sensor.name } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { description: @sensor.description, name: @sensor.name } }
